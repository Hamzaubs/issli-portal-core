...
export const LegalReportController = {
  ...
  // ====================================================
  // 📝 EXPORT CSV "AUDIT GRADE" (Safe & Clean)
  // ====================================================
  getExport: async (req: Request, res: Response) => {
    try {
        ...
        // ✅ HEADER CONTEXT (Sanitized accents for Excel compatibility)
        let csvContent = "sep=;\n"; 
        ...
        if (type === 'journal') {
            ...
            // ✅ FOOTER: Aligned correctly & No Accents
            // ; (Date) ; (Ref) ; (Client) ; (ICE Column gets Label) ; (HT) ; (TVA) ; (TTC)
            csvContent += `;;;TOTAUX PERIODE;${formatExcelNum(sumHT)};${formatExcelNum(sumTVA)};${formatExcelNum(sumTTC)};\n`;
        ...
        // ====================================================
            ...
            // Footer: No Accents
            csvContent += `;;;;TOTAL ENCAISSE;${formatExcelNum(totalCash)};\n`;
