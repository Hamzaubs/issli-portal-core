...
export const InternalController = {
  ...
  // 💰 CREATE TRANSACTION (With Full Debt Logic)
  createTransaction: async (req: Request, res: Response) => {
    try {
      ...
      if (type === 'SALE_CASH') {
        ...
        // 🟢 DEBT LOGIC: If sale is CREDIT, we increase balance. If CASH, balance unchanged.
        if (clientId) {
          if (paymentMethod === 'CREDIT') {
             ...
             // Still track volume for loyalty analysis
      ...
      if (type === 'RETURN' || type === 'RESTOCK' || type === 'ADJUSTMENT') {
        ...
        // 🟢 DEBT LOGIC FOR RETURN: We decrease debt (refund)
      ...
      operations.push(prismaInternal.stockMovement.create({
          data: {
            ...
            // Removed paymentRef (column missing in DB)
