...
router.post('/transactions', InternalController.createTransaction); // 🟢 Uses new debt logic
...
router.post('/clients/:id/payment', InternalClientController.registerPayment); // ✅ Payment Route
