...
// NOTE: Removed 'requireAdmin' to allow Salespeople to process Returns/Exchanges via the Wizard.
// If you want strict security, add 'requireAdmin' back here.
...
router.get('/reports/export', LegalReportController.getAccountingExport);
