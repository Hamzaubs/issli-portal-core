...
router.get('/clients/:id/details', InternalClientController.getClientDetails); // ✅ Profile
router.get('/clients/:id/history', InternalClientController.getClientHistory); // ✅ History
