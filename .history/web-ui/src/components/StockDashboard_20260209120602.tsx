...
import { QuotePrinter } from './QuotePrinter'; // ✅ NEW: Professional A4 Printer
...
export const StockDashboard = ({ user }: { user: any }) => {
  ...
  const [showQuotePreview, setShowQuotePreview] = useState(false); // ✅ NEW
  ...
  const handleTransaction = async () => {
    ...
    // ✅ ADD TO QUOTE CART (Logic moved here)
    if (quoteMode) {
