...
// ✅ HELPER: Custom Debounce (No need for lodash)
...
const InternalManager: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editingId) {
                await client.put(`/internal/clients/${editingId}`, formData);
            } else {
                await client.post('/internal/clients', formData);
            }
            setShowForm(false);
            setEditingId(null);
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto min-h-screen bg-slate-50">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <button onClick={() => { setEditingId(null); setFormData({ name: '', ice: '', address: '', phone: '' }); setShowForm(true); }} 
