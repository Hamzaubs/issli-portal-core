...
export const ClientProfile: React.FC<Props> = ({ clientId, onClose }) => {
    ...
    // ✅ NEW: Selected Invoice for Payment
    ...
    // Get recent unpaid sales for the modal list (Client side filtering for UI speed)
            ...
            <div className="bg-slate-100 w-full max-w-5xl h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-slate-700 relative">
                ...
                <div className="grid grid-cols-3 gap-px bg-slate-200 border-b border-slate-200 shrink-0">
                    ...
                    <div className="bg-white p-4 flex items-center justify-between">
                        ...
                        <button onClick={() => setShowPaymentModal(true)} className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold shadow-md flex items-center gap-2 text-sm transition-all">
                    ...
                    <div className="bg-white p-4 flex items-center justify-between">
                         ...
                         <button onClick={() => setShowStatement(true)} className="px-4 py-2 bg-white border border-slate-300 text-slate-600 hover:bg-slate-50 rounded-lg font-bold text-sm flex items-center gap-2">
                            <Printer size={16}/> Relevé
                         </button>
                    </div>
                </div>
                ...
                {/* ✅ PAYMENT MODAL WITH EXACT DEBT SELECTION */}
                {showPaymentModal && (
