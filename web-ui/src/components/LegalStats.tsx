// web-ui/src/components/LegalStats.tsx
import React from 'react';
import { TrendingUp, Coins, Package, ShieldCheck } from 'lucide-react';
...
export const LegalStats: React.FC<StatsProps> = ({ metrics, loading }) => {
    ...
    // ✅ FIX: Show 2 decimals for accounting precision
    const formatMAD = (n: number) => new Intl.NumberFormat('fr-MA', { style: 'currency', currency: 'MAD', maximumFractionDigits: 2 }).format(n || 0);
