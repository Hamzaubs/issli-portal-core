            ...
            <div className="flex-1 overflow-auto">
                <table className="w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {loading ? 
                            <tr><td colSpan={isAdmin ? 5 : 4} className="p-8 text-center text-slate-400">Chargement...</td></tr> : 
                        filtered.length === 0 ? 
                            <tr><td colSpan={isAdmin ? 5 : 4} className="p-8 text-center text-slate-400">Aucun produit trouvé.</td></tr> :
                        filtered.map(p => (
